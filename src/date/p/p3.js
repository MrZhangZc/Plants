const P3ImageAPI = {
    images1: [
        { id: "p/1-1", bgImage: require("@images/5.jpg") },
        { id: "p/1-2", bgImage: require("@images/5.jpg") },
    ...
    images2: [
        { id: "p/2-1", bgImage: require("@images/6.jpg") },
        { id: "p/2-2", bgImage: require("@images/6.jpg") },
        { id: "p/2-3", bgImage: require("@images/6.jpg") },
        { id: "p/2-4", bgImage: require("@images/6.jpg") },
        { id: "p/2-5", bgImage: require("@images/6.jpg") },
        { id: "p/2-6", bgImage: require("@images/6.jpg"), zzc: "none" },
        { id: "p/2-7", bgImage: require("@images/6.jpg"), zzc: "none" },
        { id: "p/2-8", bgImage: require("@images/6.jpg"), zzc: "none" }
    ],
